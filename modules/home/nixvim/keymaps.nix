  ...
  programs.nixvim = {
    ...
    keymaps = [
      ...
      }
      {
        ...
        options = {
          silent = true;
          desc = "Save File and Quite Window";
        };
      }
      ...
      }
      {
        mode = [ "n" ];
        key = "[d";
        action = "<cmdlua vim.diagnostic.goto_prev()<CR>";
        options = {
          silent = true;
      ...
      }
      {
        mode = [ "n" ];
        key = "<leader>uc";
        action = "<cmd>set conceallevel=2<CR>";
        options = {
          silent = true;
      ...
      }
      {
        mode = [ "n" ];
        key = "<leader>uh";
        action = "<cmd>lua vim.lsp.inlay_hint(0)<CR>";
        options = {
          silent = true;
